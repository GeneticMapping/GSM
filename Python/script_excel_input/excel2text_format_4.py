...
file = open("C:/TG/codigos/python_scripts/script_excel_input/excel2text_format_4/PatientsData.txt", 'w')
file.close()
...
for f in listdir("C:/TG/codigos/python_scripts/script_excel_input/inputs"):
        ...
        for worksheet_name in worksheets:
                ...
                curr_col = 10
                file_name = ""
                file = open("C:/TG/codigos/python_scripts/script_excel_input/excel2text_format_4/PatientsData.txt", 'a')
                ...
                file = open("C:/TG/codigos/python_scripts/script_excel_input/excel2text_format_4/"+file_name, 'w')
